 ...
 * keeps track of the items scanned in and calculates the final price of the 
 * products when the cashier indicates they are done scanning items. 
 * When the customer pays for their products, invoice and time/date of 
 * interaction is logged and the inventory is updated.
 *
 ***********************************************/
